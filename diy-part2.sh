...
cp -rf feeds/openwrt-passwall-packages/sing-box feeds/packages/net/sing-box
rm -rf feeds/packages/net/xray-core
cp -rf feeds/openwrt-passwall-packages/xray-core feeds/packages/net/xray-core
